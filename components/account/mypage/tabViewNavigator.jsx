...
import CompletedItemList from "./pendAndCompleteComponents/CompletedItemList";
import PendedItemList from "./pendAndCompleteComponents/PendedItemList";
  ...
  const renderScene = ({ route }) => {
    switch (route.key) {
      case "pending":
        ...
        return <PendedItemList item={pendingList} />;
      case "complete":
